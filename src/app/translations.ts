...
export const TRANSLATIONS = {
  ...
  "Connect will open the session directly without asking again.": { "zh-Hans": "之后连接将直接打开会话，不再询问。", "zh-Hant": "之後連接將直接打開會話，不再詢問。", "fa": "از این پس «اتصال» نشست را مستقیماً و بدون پرسش باز می‌کند.", "ru": "Подключение будет открывать сессию сразу, без повторного запроса." },
